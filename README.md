...
- **KinematicReco/**: Contains ROOT macros and python scripts for assessing kinematic resolutions.
...
To produce kinematic resolutions plots, go to KinematicReco and run the Make2D_yResoPlots.C macro on an output tree produced either by the ROOT macros in Run/ or by RetrieveKinematics.C. The kinematic resolution plot is produced using merged_resolution.py.