...
void New_Podio_ExtractYield_StandardBinning_5x41() {
  // Settings
  Float_t E_ebeam = 5;
  Float_t E_pbeam = 41;
  ...
  // "./Campaign_25.10.0/5x41/shorter_5x41_Q2_1_v25.10.0_filelist.txt",
  // "./Campaign_25.10.0/5x41/shorter_5x41_Q2_10_v25.10.0_filelist.txt",
  // "./Campaign_25.10.0/5x41/shorter_5x41_Q2_100_v25.10.0_filelist.txt",
  // "./Campaign_25.10.0/5x41/shorter_5x41_Q2_1000_v25.10.0_filelist.txt"
  // };
  std::vector<TString> filenames = {
    "./Campaign_25.10.0/5x41/merged_5x41_Q2_1.root",
    "./Campaign_25.10.0/5x41/merged_5x41_Q2_10.root",
    "./Campaign_25.10.0/5x41/merged_5x41_Q2_100.root"
  };
  
  std::vector<double> gen_xsecs = {4.00E-01,2.03E-02,2.87E-04}; // ub
  std::vector<double> q2_vals = {1, 10, 100};
