...
void New_Podio_ExtractYield_StandardBinning_10x100() {
  // Settings
  Float_t E_ebeam = 10;
  Float_t E_pbeam = 100;
  ...
  // "./Campaign_25.10.0/10x100/shorter_10x100_Q2_1_v25.10.0_filelist.txt",
  // "./Campaign_25.10.0/10x100/shorter_10x100_Q2_10_v25.10.0_filelist.txt",
  // "./Campaign_25.10.0/10x100/shorter_10x100_Q2_100_v25.10.0_filelist.txt",
  // "./Campaign_25.10.0/10x100/shorter_10x100_Q2_1000_v25.10.0_filelist.txt"
  // };
  std::vector<TString> filenames = {
    "./Campaign_25.10.0/10x100/merged_10x100_Q2_1.root",
    "./Campaign_25.10.0/10x100/merged_10x100_Q2_10.root",
    "./Campaign_25.10.0/10x100/merged_10x100_Q2_100.root",
    "./Campaign_25.10.0/10x100/merged_10x100_Q2_1000.root"
  };
  
  std::vector<double> gen_xsecs = {5.56E-01,4.00E-02,1.34E-03,6.82E-06}; // ub
